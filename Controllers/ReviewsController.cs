...
namespace AppBooks.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BookId,UserName,Rating,Comment")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BookId,UserName,Rating,Comment")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
